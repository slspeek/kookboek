...
{Nasi goreng}
    ...
    {%
      ...
      \step Verwijder de rode peper uit nasi pakket. Gebruik hem niet.
      ...
      \step Voeg het nasi pakket toe. Roerbak tot ze gaar is.
      \step Voeg de temp\'{e} toe.
      \step Schep de rijst erdoorheen.
      \step Bak de eieren als spiegelei in een aparte koekenpan.
      \step Schep de komkommer blokjes door de nasi en roerbak haar kort mee.
      \step Serveer de nasi met kroepoek.
    }

    \suggestion
    {
      Hier past goed \linkto{rec:pindasaus}{pindasaus} bij.
    }
