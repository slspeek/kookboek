...
{Tahoe met ketjap}
    ...
    {%
        ...
        \step Verhit de olie in een koekenpan en bak de tahoe snel bruin. Neem ze uit de
    ...
    \suggestion
    {
      Hier past goed \linkto{rec:roedjak}{roedjak} bij. Met iets zoets als toetje is het dan een hele maaltijd.
    }
\end{recipe}
