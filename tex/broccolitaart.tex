...
{Broccoli taart}
    ...
    {%
	    ...
	    \step Klop de eieren met de slagroom los in een kommetje. Voeg peper, zout en de bieslook fijn geknipt toe.
	    \step Kraak de cashewnoten met de onderkant van een mok op de snijplank.
	    ...
	    \step Schenk het slagroom mengsel erover.
