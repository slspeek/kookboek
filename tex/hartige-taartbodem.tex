...
{Hartige taartbodem}
    ...
    {%
        ...
        \step Vet je quiche vorm in met boter.
        \step Verwarm de oven voor op \unit[180]{\textcelcius}.
        \step Rol het deeg uit op een oppervlak groter dan je bakvorm. Bestrooi het oppervlak
        van te voren met bloem.
        \step Rol het deeg om de deegroller en breng het over in de quiche vorm.
        \step Prik met een vork veel gaatjes in de bodem.
        \step Verkreukel een blad bakpapier en doe daarin de steunvulling.
